<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @auth
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-jet-nav-link href="{{ route('species.index', ['showInprogress' => false]) }}" :active="request()->routeIs('species.*')">
                            {{ __('Liigid') }}
                        </x-jet-nav-link>
                    </div>
                    @can('estname_access')
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @if (Route::has('login'))
            <x-jet-responsive-nav-link href="{{ route('login') }}" class="hover:border-indigo-700">
                    {{ __('Log in') }}
                </x-jet-responsive-nav-link>
            @endif
            @if (Route::has('register'))
            <x-jet-responsive-nav-link href="{{ route('register') }}" class="hover:border-indigo-700">
                    {{ __('Register') }}
                </x-jet-responsive-nav-link>
            @endif
        </div>
    ...
    @auth
        ...
        <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
            <div class="pt-2 pb-3 space-y-1">
                <x-jet-responsive-nav-link href="{{ route('species.index', ['showInprogress' => false]) }}" :active="request()->routeIs('species.*')">
                    {{ __('Liigid') }}
                </x-jet-responsive-nav-link>
            </div>
            <div class="pt-2 pb-3 space-y-1">
